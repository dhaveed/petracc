...
<head>
    ...
    <title>Petra Christian Centre - Let's Talk</title>
            ...
            <div class="wrapper">
                <div class="root-contact">
                            ...
                            <div class="col-lg-6">
                                <div class="box-info-contact">
                                    ...
                                    <ul>
                                        <li>
                                            <span>Phone</span>
                                            <a href="tel:+2347017387222">07017387222</a>
                                        </li>
                                        <li>
                                            <span>Email</span>
                                            <a href="mailto:info@petracc.org">info@petracc.org</a>
                                        </li>
                                        <li>
                                            <span>Addresses</span>
                                            <p class="mt-10">
                                                <strong>Abuja: </strong>
                                                NAF Convention Centre, Kado, Abuja
                                            </p>

                                            <p class="mt-20">
                                                <strong>Lagos (Lekki): </strong>
                                                Delight Center, 4 Oriwu Street
                                                <br> (via Elf Bus-stop), Lekki 1 Lagos
                                            </p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="entry">
                                                    ...
                                                    <input id="form_name" type="text" name="name"
                                                        ...
                                                        data-error="Please input your fullname.">
                                                </div>
                    ...
                    <div class="container-fluid section-margin ">
                        <!-- <div class="map-custom" id="map" data-dsn-lat="9.088168" data-dsn-len="7.4247535"
                            data-dsn-zoom="14">
                        </div> -->
                        <iframe class="map-custom" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15758.92769042778!2d7.4247535!3d9.088168!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x64723b3648f4aae1!2sNAF%20Conference%20Centre%20and%20Suites!5e0!3m2!1sen!2sng!4v1585413019458!5m2!1sen!2sng&zoom=50" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                </div>
                <footer>
...
<script>
  ...
  gtag('config', 'UA-162851191-1');
    ...
    <!-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTBP1WmcOdIhyeDVpgGwCM0PUQXNLMLQE&callback=initMap"></script> -->
