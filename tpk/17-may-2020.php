                ...
                <div class="header-single-post" data-dsn-header="project">
                    ...
                    <div class="container">
                        ...
                        <div class="inner-box m-section">
                            <div class="post-info">
                                <a href="#" class="blog-post-date dsn-link">17th May, 2020</a>
                            </div>

                            <h3 class="title-box mt-10">Church at home</h3>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 col-lg-6   col-md-6 kids-week">
                                <div class="kcard" style="background-image: url('https://img.youtube.com/vi/sjQMY_G0iGI/0.jpg'); background-position: center center;">
                                    <div class="content">
                                        <h2 class="ktitle" style="text-align: left;">
                                            Rock Town - Peace Patrol 
                                        </h2>
                                        <a href="https://youtu.be/sjQMY_G0iGI" target="_blank" class="btn">Watch Video</a>
                                    </div>
                                </div>
                            </div>

                            <div class="col-sm-12 col-lg-6   col-md-6 kids-week">
                                <div class="kcard" style="background-image: url('https://img.youtube.com/vi/DH58XlRQ90k/0.jpg'); background-position: center center;">
                                    <div class="content">
                                        <h2 class="ktitle" style="text-align: left;">
                                            Treehouse - I can talk to God
                                        </h2>
                                        <a href="https://youtu.be/DH58XlRQ90k" target="_blank" class="btn">Watch Video</a>
                                    </div>
                                </div>
                            </div>
                        </div>
