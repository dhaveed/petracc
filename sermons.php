...
<head>
    ...
    <title>Petra Christian Centre - Sermons</title>
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-80">
                            <div class="col-12 latest-sermon">
                                ...
                                <iframe class="scard mega" width="1110" height="650" src="https://www.youtube.com/embed/SPoUbJjUQtw?enablejsapi=1&disablekb=1&controls=0&showinfo=0&loop=1&modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                        ...
                        <div class="row social-groups-row">
                            <!-- <div class="col-md-4 social-groups-column">
                                <div class="scard" style="background-image: url('https://img.youtube.com/vi/SPoUbJjUQtw/0.jpg')">
                                <div class="content">
                                    <h2 class="stitle">No Fear Here!</h2>
                                    <p class="copy">by Pastor Ayo Ajani</p>
                                    <a href="https://web.facebook.com/groups/240045177152522?ref=pages_profile_groups_tab&source_id=263940756963354" target="_blank" class="btn">Watch</a>
                                </div>
                            </div>
                            </div> -->
                            <div class="col-md-4 social-groups-column">
                                <div class="scard" style="background-image: url('https://img.youtube.com/vi/gzF55-w14Lk/0.jpg'); background-size: cover; background-position: center center;">
                                    <div class="content">
                                        ...
                                        <p class="copy"></p>
                                        <a href="https://www.youtube.com/watch?v=gzF55-w14Lk&t=54s" target="_blank" class="btn">Watch</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 social-groups-column">
                            ...
                            <div class="col-md-4 social-groups-column">
                                <div class="scard" style="background-image: url('https://img.youtube.com/vi/p8CABXme7_Y/0.jpg'); background-size: cover; background-position: center center;">
                                    <div class="content">
                                        ...
                                        <p class="copy"></p>
                                        <a href="https://www.youtube.com/watch?v=p8CABXme7_Y&t=774s" target="_blank" class="btn">Watch</a>
                                    </div>
                                </div>
                            </div>
                        </div>
